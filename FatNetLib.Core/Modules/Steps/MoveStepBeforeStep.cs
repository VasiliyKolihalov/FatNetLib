...
{
    public class MoveStepBeforeStep : IStep
    {
        private readonly IStepTreeNode _rootNode;
        private readonly StepId _targetStepId;
        private readonly StepId _placeStepId;

        public MoveStepBeforeStep(IStepTreeNode rootNode, StepId targetStepId, StepId placeStepId)
        {
            _rootNode = rootNode;
        ...
        public void Run()
        {
            ...
            placeNode.Parent!.ChildNodes.Insert(placeIndex, targetNode);
