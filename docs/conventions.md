...
# Server
Главный пир в сети. Координирует коннекшн. Также является полноправным отправителем и получателем пакеты.

# Client
Рядовай пир в сети. Подсоединяется к существующему коннекшну, отправиляет и получает пакетов.
